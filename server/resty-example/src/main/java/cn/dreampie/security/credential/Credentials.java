...
public class Credentials {
  ...
  public void zhouxiang(){
	  System.out.println("===========in zhouxiang===============");
  }
  ...
  public Principal getPrincipal(String username) {
    ...
    if (Constant.cacheEnabled) {
      ...
      if (principal == null) {
    	...
    	MyLogger.logImpor("cache没有开启");
      boolean find = false;
      //size>1000的时候为什么要从数据库中读取
