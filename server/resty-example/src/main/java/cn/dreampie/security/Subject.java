...
public static Principal getPrincipal() {
  ...
  public static void check(String httpMethod, String path) {
	  MyLogger.log("httpMethod:"+httpMethod+" path:"+path);
